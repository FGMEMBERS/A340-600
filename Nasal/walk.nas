...
# Airbus A340-600 Walk code (to walk around the interior)
...
var walk_about = func(wa_distance) {
   if (getprop("sim/current-view/view-number") == 0 or getprop("sim/current-view/view-number") == 10 or getprop("sim/current-view/view-number") == 11) {
